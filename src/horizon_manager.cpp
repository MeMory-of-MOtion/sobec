...
void HorizonManager::setPoseReferenceLF(const unsigned long &time, const std::string &nameCostLF,
                                        const pinocchio::SE3 &ref_placement) {
  std::cout << "Set left position to " << ref_placement.translation()[0] << ", " << ref_placement.translation()[1]
...
void HorizonManager::setPoseReferenceRF(const unsigned long &time, const std::string &nameCostRF,
                                        const pinocchio::SE3 &ref_placement) {
  std::cout << "Set right position to " << ref_placement.translation()[0] << ", " << ref_placement.translation()[1]
            << ", " << ref_placement.translation()[2] << std::endl;
  boost::static_pointer_cast<crocoddyl::ResidualModelFramePlacement>(
...
void HorizonManager::setForceReferenceLF(const unsigned long &time, const std::string &nameCostLF,
...
void HorizonManager::setForceReferenceRF(const unsigned long &time, const std::string &nameCostRF,
                                         const eVector6 &reference) {
...
void HorizonManager::solve(const Eigen::VectorXd &measured_x, const std::size_t &ddpIteration,
