...
namespace sobec {
	...
	void OCP::initialize(const OCPSettings &settings,
		...
		swing_trajectory_left_->generate(0., OCP_settings_.TsimpleSupport * OCP_settings_.Dt, starting_position_left_, final_position_left_);
		swing_trajectory_right_->generate(0., OCP_settings_.TsimpleSupport * OCP_settings_.Dt, starting_position_right_, final_position_right_);
