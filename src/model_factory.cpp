...
void ModelMaker::defineFeetWrenchCost(Cost &costCollector, const Support &support) {
  ...
  crocoddyl::WrenchCone wrenchCone_LF = crocoddyl::WrenchCone(coneRotationLeft, settings_.mu, settings_.coneBox, 4,
                                                              true, settings_.minNforce, settings_.maxNforce);
  crocoddyl::WrenchCone wrenchCone_RF = crocoddyl::WrenchCone(coneRotationRight, settings_.mu, settings_.coneBox, 4,
                                                              true, settings_.minNforce, settings_.maxNforce);
