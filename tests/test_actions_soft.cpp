...
void register_action_model_unit_tests(
  ...
  ts->add(BOOST_TEST_CASE(
      boost::bind(&test_calc_returns_state, iam_type, dam_type, ref_type)));
  ts->add(BOOST_TEST_CASE(
      boost::bind(&test_calc_returns_a_cost, iam_type, dam_type, ref_type)));
  ts->add(BOOST_TEST_CASE(boost::bind(&test_partial_derivatives_action_model,
                                      iam_type, dam_type, ref_type)));
  ...
  ts->add(BOOST_TEST_CASE(
      boost::bind(&test_calc_equivalent_euler, iam_type, dam_type, ref_type)));
