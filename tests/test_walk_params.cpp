...
BOOST_AUTO_TEST_CASE(test_ocp_walk_params) {
  ...
  std::cout << "stateImportance = " << ocpparams.stateImportance.transpose() << std::endl;
  std::cout << "stateTerminalImportance = " << ocpparams.stateTerminalImportance.transpose() << std::endl;
  std::cout << "controlImportance = " << ocpparams.controlImportance.transpose() << std::endl;
  std::cout << "vcomImportance = " << ocpparams.vcomImportance.transpose() << std::endl;
  std::cout << "forceImportance = " << ocpparams.forceImportance.transpose() << std::endl;
  ...
  std::cout << "conePenaltyWeight = " << ocpparams.conePenaltyWeight << std::endl;
  std::cout << "coneAxisWeight = " << ocpparams.coneAxisWeight << std::endl;
  std::cout << "refForceWeight = " << ocpparams.refForceWeight << std::endl;
  std::cout << "impactAltitudeWeight = " << ocpparams.impactAltitudeWeight << std::endl;
  std::cout << "impactVelocityWeight = " << ocpparams.impactVelocityWeight << std::endl;
  std::cout << "impactRotationWeight = " << ocpparams.impactRotationWeight << std::endl;
  std::cout << "refMainJointsAtImpactWeight = " << ocpparams.refMainJointsAtImpactWeight << std::endl;
  std::cout << "verticalFootVelWeight = " << ocpparams.verticalFootVelWeight << std::endl;
  ...
  std::cout << "footMinimalDistance = " << ocpparams.footMinimalDistance << std::endl;
  std::cout << "feetCollisionWeight = " << ocpparams.feetCollisionWeight << std::endl;
  std::cout << "kktDamping = " << ocpparams.kktDamping << std::endl;
  std::cout << "stateTerminalWeight = " << ocpparams.stateTerminalWeight << std::endl;
  std::cout << "solver_th_stop = " << ocpparams.solver_th_stop << std::endl;
  std::cout << "transitionDuration = " << ocpparams.transitionDuration << std::endl;
  std::cout << "minimalNormalForce = " << ocpparams.minimalNormalForce << std::endl;
  std::cout << "withNormalForceBoundOnly = " << ocpparams.withNormalForceBoundOnly << std::endl;
}
