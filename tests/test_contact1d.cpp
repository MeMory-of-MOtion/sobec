...
void test_partial_derivatives_against_numdiff(ContactModelMaskTypes::Type mask_type,
  ...
  //   boost::static_pointer_cast<sobec::newcontacts::ContactData1D>(data);
  //   std::cout << " xref : " << std::endl; std::cout << md->get_reference() <<
  //   std::endl; std::cout << " type : " << std::endl; std::cout <<
  //   md->get_type() << std::endl; std::cout << " mask : " << std::endl;
