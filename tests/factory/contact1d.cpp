...
boost::shared_ptr<crocoddyl::ContactModelAbstract> ContactModel1DFactory::create(
    ...
    PinocchioReferenceTypes::Type reference_type, Eigen::Vector2d gains, const std::string frame_name,
    std::size_t nu) const {
    ...
    case ContactModelMaskTypes::X: {
      if (reference_type == PinocchioReferenceTypes::LOCAL) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::x, pinocchio::LOCAL);
      } else if (reference_type == PinocchioReferenceTypes::WORLD) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::x, pinocchio::WORLD);
      } else if (reference_type == PinocchioReferenceTypes::LOCAL_WORLD_ALIGNED) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::x, pinocchio::LOCAL_WORLD_ALIGNED);
      }
      break;
    }
    case ContactModelMaskTypes::Y: {
      if (reference_type == PinocchioReferenceTypes::LOCAL) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::y, pinocchio::LOCAL);
      } else if (reference_type == PinocchioReferenceTypes::WORLD) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::y, pinocchio::WORLD);
      } else if (reference_type == PinocchioReferenceTypes::LOCAL_WORLD_ALIGNED) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::y, pinocchio::LOCAL_WORLD_ALIGNED);
      }
      break;
    }
    case ContactModelMaskTypes::Z:
      if (reference_type == PinocchioReferenceTypes::LOCAL) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::z, pinocchio::LOCAL);
      } else if (reference_type == PinocchioReferenceTypes::WORLD) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::z, pinocchio::WORLD);
      } else if (reference_type == PinocchioReferenceTypes::LOCAL_WORLD_ALIGNED) {
        contact = boost::make_shared<sobec::newcontacts::ContactModel1D>(
            state, frame_id, xref, nu, gains, sobec::newcontacts::Vector3MaskType::z, pinocchio::LOCAL_WORLD_ALIGNED);
      }
      break;
    default:
