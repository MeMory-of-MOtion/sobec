...
std::ostream& operator<<(std::ostream& os, DifferentialActionModelTypes::Type type) {
  switch (type) {
    ...
    //   break;
    // case DifferentialActionModelTypes::DifferentialActionModelContact3DFwdDynamics_TalosArm_LOCAL:
    //   os << "DifferentialActionModelContact3DFwdDynamics_TalosArm_LOCAL";
    //   break;
    // case DifferentialActionModelTypes::DifferentialActionModelContact3DFwdDynamics_TalosArm_WORLD:
    //   os << "DifferentialActionModelContact3DFwdDynamics_TalosArm_WORLD";
    //   break;
...
boost::shared_ptr<crocoddyl::DifferentialActionModelAbstract> DifferentialActionModelFactory::create(
  ...
  switch (type) {
    ...
    //   break;
    // case DifferentialActionModelTypes::DifferentialActionModelContact3DFwdDynamics_TalosArm_LOCAL:
    //   action = create_contactFwdDynamics(StateModelTypes::StateMultibodyContact3D_TalosArm,
    //                                      ActuationModelTypes::ActuationModelFull, false, pinocchio::LOCAL);
    //   break;
    // case DifferentialActionModelTypes::DifferentialActionModelContact3DFwdDynamics_TalosArm_WORLD:
    //   action =
    //       create_contactFwdDynamics(StateModelTypes::StateMultibodyContact3D_TalosArm,
    //                                 ActuationModelTypes::ActuationModelFull, false, pinocchio::LOCAL_WORLD_ALIGNED);
    //   break;
    // case DifferentialActionModelTypes::DifferentialActionModelContact1DFwdDynamics_TalosArm:
    //   action = create_contactFwdDynamics(StateModelTypes::StateMultibodyContact1D_TalosArm,
    //                                      ActuationModelTypes::ActuationModelFull, false);
    //   break;
    // case DifferentialActionModelTypes::DifferentialActionModelContactFwdDynamics_HyQ:
...
//       }
//       break;
//     case StateModelTypes::StateMultibodyContact3D_TalosArm:
//       contact->addContact("lf", boost::make_shared<crocoddyl::ContactModel3D>(
//                                     state, state->get_pinocchio()->getFrameId("gripper_left_fingertip_1_link"),
//                                     Eigen::Vector3d::Zero(), actuation->get_nu(),
...
//                     0.1);
//       break;
//     case StateModelTypes::StateMultibodyContact1D_TalosArm:
//       contact->addContact("lf", boost::make_shared<crocoddyl::ContactModel1D>(
//                                     state, state->get_pinocchio()->getFrameId("gripper_left_fingertip_1_link"),
//                                     Eigen::Vector3d::Zero(), actuation->get_nu(),
//                                     Eigen::Vector2d::Zero(),  // Eigen::Vector2d(0., 50.),
//                                     Vector3MaskType::z, pinocchio::LOCAL_WORLD_ALIGNED));
//       // force regularization
//       cost->addCost("lf",
//                     boost::make_shared<crocoddyl::CostModelResidual>(
//                         state, boost::make_shared<crocoddyl::ResidualModelContactForce>(
