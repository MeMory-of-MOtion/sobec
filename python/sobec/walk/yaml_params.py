'''
This module provides functions to write paams into a yamlfile. Params can be either python params from
sobec.walk.params, or c++ params from sobec.OCPWalkParams
- yamlWriteParams
...
def flattenDictArrayValues(paramsAsDict):
    ...
    for k,v in paramsAsDict.items():
        ...
        if isinstance(v,sobec.sobec_pywrap.StdVectorStdStringIndex_):
...
if __name__ == "__main__":
    ...
    cppdict = { k:v for params in [ocpparams,mpcparams] for k,v in paramsToDict(params).items() }
