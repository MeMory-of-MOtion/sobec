...
namespace bp = boost::python;
  ...
  void exposeOCPRobotWrapper() {
    ...
    bp::class_<OCPRobotWrapper>("OCPRobotWrapper",
                                bp::init<
      ...
      .add_property("x0",
                    bp::make_getter(&OCPRobotWrapper::x0, bp::return_internal_reference<>()),
                    bp::make_setter(&OCPRobotWrapper::x0),
                    "Reference state")
      .add_property("com0",
                    bp::make_getter(&OCPRobotWrapper::com0, bp::return_internal_reference<>()),
      ...
      .add_property("model",
                    ...
                    bp::make_setter(&OCPRobotWrapper::model),
                    "Pinocchio model")
      .add_property("data",
                    bp::make_getter(&OCPRobotWrapper::data, bp::return_internal_reference<>()),
                    "pinocchio data")
      // .add_property("data",
  ...
  void exposeOCPParams()
  {
    ...
    bp::class_<OCPWalkParams>("OCPWalkParams",
                              bp::init<>(bp::args("self"),
                                         "Empty initialization of the OCP params"))
      // .add_property(
      ...
      // .add_property("solver_maxiter", bp::make_getter(&OCPWalkParams::solver_maxiter),
...
void exposeOCPWalkclass() {
  ...
  bp::class_<OCPWalk>("OCPWalk",
                      bp::init<boost::shared_ptr<OCPRobotWrapper>,boost::shared_ptr<OCPWalkParams> >(
                          bp::args("self"), "Initialize the OCP from robot and params"))
      // .add_property(
      //     "vcomRef",
      //     bp::make_getter(&OCPWalk::vcomRef, bp::return_internal_reference<>()),
      //     bp::make_setter(&OCPWalk::vcomRef),
      //     "Reference of the com velocity, to tune the OCP at runtime.")
      // .add_property("solver_th_stop", bp::make_getter(&OCPWalk::solver_th_stop),
