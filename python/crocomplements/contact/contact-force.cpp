...
void exposeResidualContactForce() {
  bp::register_ptr_to_python<boost::shared_ptr<sobec::newcontacts::ResidualModelContactForce> >();

  bp::class_<sobec::newcontacts::ResidualModelContactForce, bp::bases<crocoddyl::ResidualModelContactForce> >(
