...
void exposeResidual2DSurface() {
  ...
  bp::class_<ResidualModel2DSurface, bp::bases<ResidualModelAbstract> >(
      ...
      bp::init<boost::shared_ptr<StateMultibody>, pinocchio::FrameIndex, Eigen::Vector2d, double, double, double,
               std::size_t>(
      ...
      .def(bp::init<boost::shared_ptr<StateMultibody>, pinocchio::FrameIndex, Eigen::Vector2d, double, double, double>(
          ...
          ":param orientation: yaw of the opposite foot\n"
          ":param alpha: orientation of cone limits"))
      .def<void (ResidualModel2DSurface::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                            const Eigen::Ref<const Eigen::VectorXd>&,
                                            const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &ResidualModel2DSurface::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (ResidualModel2DSurface::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                            const Eigen::Ref<const Eigen::VectorXd>&,
                                            const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualModel2DSurface::calcDiff, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &ResidualModel2DSurface::createData, bp::with_custodian_and_ward_postcall<0, 2>(),
           bp::args("self", "data"),
      ...
      .def("set_Ab", &ResidualModel2DSurface::set_Ab, bp::args("self", "support_translation", "orientation"))
      .add_property("A", bp::make_function(&ResidualModel2DSurface::get_A, bp::return_internal_reference<>()),
                    &ResidualModel2DSurface::set_A, "Inequality matrix")
      .add_property("b", bp::make_function(&ResidualModel2DSurface::get_b, bp::return_internal_reference<>()),
  ...
  bp::class_<ResidualData2DSurface, bp::bases<ResidualDataAbstract> >(
      ...
      .add_property("pinocchio", bp::make_getter(&ResidualData2DSurface::pinocchio, bp::return_internal_reference<>()),
                    "pinocchio data");
}
