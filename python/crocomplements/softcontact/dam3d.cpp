...
void exposeDAMSoftContact3DFwdDyn() {
  bp::register_ptr_to_python<
      boost::shared_ptr<DifferentialActionModelSoftContact3DFwdDynamics>>();

  bp::class_<DifferentialActionModelSoftContact3DFwdDynamics,
      ...
      .def<void (DifferentialActionModelSoftContact3DFwdDynamics::*)(
          ...
          const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff",
          &DifferentialActionModelSoftContact3DFwdDynamics::calcDiff,
          bp::args("self", "data", "x", "u"),
      ...
      .def<void (DifferentialActionModelSoftContact3DFwdDynamics::*)(
          ...
          bp::args("self", "data", "x"))
      .def("createData",
           &DifferentialActionModelSoftContact3DFwdDynamics::createData,
           bp::args("self"), "Create the Euler integrator data.")
      .def("set_force_cost",
           &DifferentialActionModelSoftContact3DFwdDynamics::set_force_cost,
           bp::args("self", "force_des", "force_weight"),
           "Initialize force reference and cost weight ")
      .add_property(
          "Kp",
          bp::make_function(
              &DifferentialActionModelSoftContact3DFwdDynamics::get_Kp,
      ...
      .add_property(
          "Kv",
          bp::make_function(
              &DifferentialActionModelSoftContact3DFwdDynamics::get_Kv,
              bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "oPc",
          bp::make_function(
              &DifferentialActionModelSoftContact3DFwdDynamics::get_oPc,
              bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "f_des",
          bp::make_function(
              &DifferentialActionModelSoftContact3DFwdDynamics::get_force_des,
              bp::return_value_policy<bp::return_by_value>()),
          &DifferentialActionModelSoftContact3DFwdDynamics::set_force_des,
          "Desired force in the cost")
      .add_property(
          "f_weight",
          bp::make_function(&DifferentialActionModelSoftContact3DFwdDynamics::
                                get_force_weight,
                            bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "ref",
          bp::make_function(
              &DifferentialActionModelSoftContact3DFwdDynamics::get_ref,
              bp::return_value_policy<bp::return_by_value>()),
      ...
      .add_property(
          "id",
          bp::make_function(
              &DifferentialActionModelSoftContact3DFwdDynamics::get_id,
              bp::return_value_policy<bp::return_by_value>()),
          &DifferentialActionModelSoftContact3DFwdDynamics::set_id,
          "Contact frame id");

  bp::register_ptr_to_python<
      boost::shared_ptr<DifferentialActionDataSoftContact3DFwdDynamics>>();

  bp::class_<DifferentialActionDataSoftContact3DFwdDynamics,
      ...
      .add_property(
          "lJ",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::lJ,
              bp::return_internal_reference<>()),
          "Jacobian of the contact frame in LOCAL")
      .add_property(
          "oJ",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::oJ,
              bp::return_internal_reference<>()),
          "Jacobian of the contact frame in LOCAL_WORLD_ALIGNED")
      .add_property("lv_partial_dq",
                    bp::make_getter(
                        &sobec::DifferentialActionDataSoftContact3DFwdDynamics::
                            lv_partial_dq,
                        bp::return_internal_reference<>()),
                    "Partial derivative of LOCAL contact frame velocity w.r.t. "
                    "joint positions")
      .add_property("lv_partial_dv",
                    bp::make_getter(
                        &sobec::DifferentialActionDataSoftContact3DFwdDynamics::
                            lv_partial_dv,
                        bp::return_internal_reference<>()),
      ...
      .add_property(
          "aba_dq",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::aba_dq,
              bp::return_internal_reference<>()),
          "Partial derivative of joint acceleration w.r.t. joint positions")
      .add_property(
          "aba_dv",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::aba_dv,
              bp::return_internal_reference<>()),
          "Partial derivative of joint accelerations w.r.t. joint velocities")
      .add_property(
          "aba_dtau",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::aba_dtau,
              bp::return_internal_reference<>()),
          "Partial derivative of joint accelerations w.r.t. joint torques")
      .add_property(
          "df_dx",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::df_dx,
              bp::return_internal_reference<>()),
          "Partial derivative of contact force w.r.t. state")
      .add_property("df_dx_copy",
                    bp::make_getter(
                        &sobec::DifferentialActionDataSoftContact3DFwdDynamics::
                            df_dx_copy,
                        bp::return_internal_reference<>()),
      ...
      .add_property(
          "pinForce",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::pinForce,
              bp::return_internal_reference<>()),
      ...
      .add_property(
          "fext",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::fext,
              bp::return_internal_reference<>()),
      ...
      .add_property(
          "fext_copy",
          bp::make_getter(
              &sobec::DifferentialActionDataSoftContact3DFwdDynamics::fext_copy,
              bp::return_internal_reference<>()),
          "Vector of spatial wrenches due to visco-elastic contact, expressed "
