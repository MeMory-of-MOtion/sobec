...
void exposeResidualCenterOfFriction() {
  bp::register_ptr_to_python<boost::shared_ptr<ResidualModelCenterOfFriction> >();

  bp::class_<ResidualModelCenterOfFriction, bp::bases<ResidualModelAbstract> >(
      "ResidualModelCenterOfFriction", bp::init<boost::shared_ptr<StateMultibody>, pinocchio::FrameIndex, std::size_t>(
      ...
      .def<void (ResidualModelCenterOfFriction::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                   const Eigen::Ref<const Eigen::VectorXd>&,
                                                   const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calc", &ResidualModelCenterOfFriction::calc, bp::args("self", "data", "x", "u"),
      ...
      .def<void (ResidualModelCenterOfFriction::*)(const boost::shared_ptr<ResidualDataAbstract>&,
                                                   const Eigen::Ref<const Eigen::VectorXd>&,
                                                   const Eigen::Ref<const Eigen::VectorXd>&)>(
          "calcDiff", &ResidualModelCenterOfFriction::calcDiff, bp::args("self", "data", "x", "u"),
      ...
      .def("createData", &ResidualModelCenterOfFriction::createData, bp::with_custodian_and_ward_postcall<0, 2>(),
           bp::args("self", "data"),
           "Create the residual data.\n\n"
           ":param data: shared data\n"
           ":return residual data.")
      .add_property("contact_id", &ResidualModelCenterOfFriction::get_contact_id,
                    &ResidualModelCenterOfFriction::set_contact_id, "Contact frame ID");

  bp::register_ptr_to_python<boost::shared_ptr<ResidualDataCenterOfFriction> >();
