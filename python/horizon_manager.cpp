...
namespace sobec {
    ...
    void exposeHorizonManager() {
        bp::class_<HorizonManager>("HorizonManager", bp::init<>())
            ...
            .def("setSwingingLF", &HorizonManager::setSwingingLF, bp::args("self", "time", "contactNameLF", "contactNameRF"))
            .def("setSwingingRF", &HorizonManager::setSwingingRF, bp::args("self", "time", "contactNameLF", "contactNameRF"))
