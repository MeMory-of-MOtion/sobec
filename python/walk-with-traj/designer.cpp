...
pinocchio::Model get_rModelComplete(RobotDesigner &self) { return self.get_rModelComplete(); }
...
pinocchio::Data get_rDataComplete(RobotDesigner &self) { return self.get_rDataComplete(); }
...
void exposeDesigner() {
  bp::class_<RobotDesigner>("RobotDesigner", bp::init<>())
      ...
      .def("get_root_frame",
           bp::make_function(&RobotDesigner::get_root_frame, bp::return_value_policy<bp::reference_existing_object>()))
      .def("getRobotMass", &RobotDesigner::getRobotMass)
      .def("get_rModel",
           bp::make_function(&RobotDesigner::get_rModel, bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_rModelComplete", bp::make_function(&RobotDesigner::get_rModelComplete,
                                                   bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_rData",
           bp::make_function(&RobotDesigner::get_rData, bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_rDataComplete", bp::make_function(&RobotDesigner::get_rDataComplete,
                                                  bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_q0",
           bp::make_function(&RobotDesigner::get_q0, bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_q0Complete",
           bp::make_function(&RobotDesigner::get_q0Complete, bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_v0",
           bp::make_function(&RobotDesigner::get_v0, bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_v0Complete",
           bp::make_function(&RobotDesigner::get_v0Complete, bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_x0",
           bp::make_function(&RobotDesigner::get_x0, bp::return_value_policy<bp::reference_existing_object>()))
      .def("get_LF_name",
      ...
      .def("get_LF_heel_id",
           bp::make_function(&RobotDesigner::get_LF_heel_id, bp::return_value_policy<bp::copy_const_reference>()))
      .def("get_RF_heel_id",
           bp::make_function(&RobotDesigner::get_RF_heel_id, bp::return_value_policy<bp::copy_const_reference>()))
      .def("get_LF_toe_id",
           bp::make_function(&RobotDesigner::get_LF_toe_id, bp::return_value_policy<bp::copy_const_reference>()))
      .def("get_RF_toe_id",
