...
void exposeResidualVelCollision() {
  ...
  bp::class_<ResidualDataVelCollision, bp::bases<ResidualDataAbstract> >(
      ...
      .add_property("pinocchio",
                    ...
                    "pinocchio data")
      .add_property("V",
                    bp::make_getter(&ResidualDataVelCollision::V, bp::return_internal_reference<>()),
                    "Planar velocity of reference frame")
      .add_property("e",
                    bp::make_getter(&ResidualDataVelCollision::e, bp::return_internal_reference<>()),
                    "Distance between collision pair")
      .add_property("Vx",
                    bp::make_getter(&ResidualDataVelCollision::Vx, bp::return_internal_reference<>()),
