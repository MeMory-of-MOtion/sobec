...
//   pinocchio::computeAllTerms(this->get_pinocchio(), d->pinocchio, q, d->tmp_xstatic.tail(nv));
//   pinocchio::computeJointJacobians(this->get_pinocchio(), d->pinocchio, q);
//   pinocchio::rnea(this->get_pinocchio(), d->pinocchio, q, d->tmp_xstatic.tail(nv), d->tmp_xstatic.tail(nv));
