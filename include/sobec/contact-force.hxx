...
void ResidualModelContactForceTpl<Scalar>::calc(const boost::shared_ptr<ResidualDataAbstract>& data,
  ...
  switch (d->contact_type) {
    case Contact1D: {
      sobec::ContactData1DTpl<Scalar>* d1d = static_cast<sobec::ContactData1DTpl<Scalar>*>(d->contact.get());
    ...
    case Contact3D: {
      sobec::ContactData3DTpl<Scalar>* d3d = static_cast<sobec::ContactData3DTpl<Scalar>*>(d->contact.get());
