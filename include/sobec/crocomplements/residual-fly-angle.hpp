...
#ifndef SOBEC_RESIDUAL_FLY_ANGLE_HPP_
#define SOBEC_RESIDUAL_FLY_ANGLE_HPP_
...
class ResidualModelFlyAngleTpl : public ResidualModelAbstractTpl<_Scalar> {
 public:
   ...
   */
  ResidualModelFlyAngleTpl(boost::shared_ptr<StateMultibody> state, const pinocchio::FrameIndex frame_id,
...
template <typename _Scalar>
struct ResidualDataFlyAngleTpl : public ResidualDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
...
#include "sobec/crocomplements/residual-fly-angle.hxx"

#endif  // SOBEC_RESIDUAL_FLY_ANGLE_HPP_
