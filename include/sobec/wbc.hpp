...
class WBC {
 ...
 public:
  ...
  Eigen::VectorXd iterate(const int &iteration, const Eigen::VectorXd &q_current, const Eigen::VectorXd &v_current,
  ...
  void set_walkingCycle(HorizonManager walkingCycle) { walkingCycle_ = walkingCycle; }

  HorizonManager get_standingCycle() { return standingCycle_; }
  void set_standingCycle(HorizonManager standingCycle) { standingCycle_ = standingCycle; }
  ...
  void setPoseRef_LF(const pinocchio::SE3 &ref_LF_pose, const unsigned long &time) {
  ...
  void setPoseRef_RF(const pinocchio::SE3 &ref_RF_pose, const unsigned long &time) {
